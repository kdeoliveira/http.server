...
export class ApolloServerBase {
  ...
  /**
   * Sets this object context to an express equivalent Request/Response body;
   * Note that if landingPage is not called, context will be set by graphQLServerOptions method.
   * In order to get cookies, graphql requests need to be made internally
